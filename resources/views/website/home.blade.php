...
<div class="container-fluid" style="display:none;" id="page-secundaria">
    ...
    <div class="card" style="width: 300px; color: black;">
        <img class="card-img-top img-fluid" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS2e_HLzSvESoaytGygSCyr90lU6FS0jE1JHrWD5CoeTsNI1iZD" alt="Card image cap">
        <div class="card-body">
